    ...
    return main_layout(
        ...
        rx.grid(
            ...
            _feature_card("calendar", "Gastos",
                          ...
                          "/gastos", T.PINK),
            _feature_card("list", "Compras",
                          "Lista de compras, categorías y recurrentes. Añade, edita y elimina con un clic.",
                          "/compras", T.CHERRY),  
            _feature_card("wallet", "Cajas",
                          "Cuentas, tarjetas y efectivo. Control total de tu patrimonio con movimientos ilimitados.",
                          "/cajas", T.PEARL),       
            _feature_card("piggy-bank", "Presupuesto",
                          "Cupos y metas de ahorro por categoría. Controla tus gastos y alcanza tus objetivos financieros.",
                          "/presupuesto", T.QUANTUM),                                                                        
